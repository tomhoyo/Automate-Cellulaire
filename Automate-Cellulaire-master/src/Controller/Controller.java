...
public class Controller {
	...
	//affecte le controller
		...
		private static final  boolean choixSurvie = true; // choix du type de model de survie
	//affecte la view
		...
		private static final int tempsDAttente = 50; // temps d'attente entre chaques générations
